...
async function school() {
    ...
    try {
        ...
        let response = await fetch("https://striveschool-api.herokuapp.com/api/product/", {
            headers: {
                "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWE1MzQyNjQ1MzM1YTAwMTgyNDZkN2UiLCJpYXQiOjE3MDUzMjU2MDYsImV4cCI6MTcwNjUzNTIwNn0.qY-G9WAzyagjHUaukEJsAD4Rd2wJtjhvwTZc1br9FOY"
            }
        });
